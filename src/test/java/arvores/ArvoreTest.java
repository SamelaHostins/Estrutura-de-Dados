...
public class ArvoreTest {
	...
	public void testCaminho() {
		System.out.println("testCaminho");
		...
		String resultadoEsperado = "1; 2; 5";
		String resultadoObtido = a5.caminho(5);
		assertEquals(resultadoEsperado, resultadoObtido);
	}

	@Test
	public void testCaminho2() {
		System.out.println("testCaminho2");
		Arvore<Integer> a6 = new Arvore<>();
		NoArvore<Integer> n1 = new NoArvore<Integer>(1);
		a6.setRaiz(n1);

		String resultadoEsperado = "1";
		String resultadoObtido = a6.caminho(1);
		assertEquals(resultadoEsperado, resultadoObtido);
	}
	...
	public void testCaminho3() {
		System.out.println("testCaminho2");
		Arvore<Integer> a7 = new Arvore<>();

		String resultadoEsperado = null;
		String resultadoObtido = a7.caminho(1);
		assertEquals(resultadoEsperado, resultadoObtido);
	}

	@Test
	public void testGrauDaArvore() {
		System.out.println("testGrauDaArvore");
		Arvore<Integer> a5 = new Arvore<>();
		NoArvore<Integer> n1 = new NoArvore<Integer>(1);
		NoArvore<Integer> n2 = new NoArvore<Integer>(2);
		NoArvore<Integer> n3 = new NoArvore<Integer>(3);
		...
		int resultadoObtido = a5.getGrau();
		assertEquals(resultadoEsperado, resultadoObtido);
	}
	...
	public void testPertence() {
		...
		Object resultadoObtido = a6.pertence(12);
		assertEquals(resultadoEsperado, resultadoObtido);
	}
